<div class="container bg-white" style="position: relative; top: -16px;"><hr>
    ...
    <i class="bi bi-plus-circle"></i> Berita
    </button>
    <div class="row">
        <div class="table-responsive" id="berita_data">  
    </div>
...
if (isset($_POST['simpan'])) {
    ...
    if ($nama_gambar != '') {
        ...
        if ($cek_upload['status']) {
            ...
            echo "<script>
                ...
                document.location='admin.php?page=berita';
            </script>";
            die;
        }
    }
    ...
    if (isset($_POST['id'])) {
        ...
        $stmt = $conn->prepare("UPDATE berita 
                                SET 
                                judul =?,
                                isi =?,
                                gambar = ?,
		...
		//insert data
        $stmt = $conn->prepare("INSERT INTO berita (judul,isi,gambar,tanggal,username)
                                VALUES (?,?,?,?,?)");
